...
## Key Features
Affine cipher–based encryption and decryption
Memristor-inspired chaotic key generation
Full printable ASCII character support
Validation of cryptographic key strength
Simple CLI-based interaction
This project blends classical cryptography with nonlinear dynamical systems to demonstrate an experimental approach to key generation.
